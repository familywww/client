      ...
      mapControl: {
        tile: [
          ...
          },
          {
            ...
            subdomains: '012',
            maps: [
              { zIndex: 1, opacity: 1.0, visible: true, type: 'base', name: '默认', url: '//api.map.baidu.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=norma', },
              ...
              { zIndex: 7, opacity: 1.0, visible: false, type: 'base', name: '午夜蓝', url: '//api.map.baidu.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=midnight', },
