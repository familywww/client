      ...
      mapControl: {
        tile: [
          ...
          },
          {
            ...
            subdomains: '012',
            maps: [
              { zIndex: 1, opacity: 1.0, visible: true , type: 'base', name: '默认', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=norma', },
              { zIndex: 2, opacity: 1.0, visible: false, type: 'base', name: '清新蓝', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=light', },
              { zIndex: 3, opacity: 1.0, visible: false, type: 'base', name: '黑夜', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=dark', },
              { zIndex: 4, opacity: 1.0, visible: false, type: 'base', name: '红色警戒', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=redalert', },
              { zIndex: 5, opacity: 1.0, visible: false, type: 'base', name: '精简', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=googlelite', },
              { zIndex: 6, opacity: 1.0, visible: false, type: 'base', name: '自然绿', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=grassgreen', },
              { zIndex: 7, opacity: 1.0, visible: false, type: 'base', name: '午夜蓝', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=midnight', },
              { zIndex: 8, opacity: 1.0, visible: false, type: 'base', name: '浪漫粉', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=pink', },
              { zIndex: 9, opacity: 1.0, visible: false, type: 'base', name: '青春绿', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=darkgreen', },
              { zIndex: 10, opacity: 1.0, visible: false, type: 'base', name: '清新蓝绿', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=bluish', },
              { zIndex: 11, opacity: 1.0, visible: false, type: 'base', name: '高端灰', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=grayscale', },
              { zIndex: 12, opacity: 1.0, visible: false, type: 'base', name: '强边界', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=hardedge', },
              ...
              { zIndex: 16, opacity: 1.0, visible: false, type: 'overlay', name: '标签', url: '//online{s}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=sl&v=020', },
            ],
            layers: [
            ],
          },
