      ...
      mapControl: {
        tile: [
          ...
          },
          {
            ...
            subdomains: '012',
            maps: [
              { name: '卫星', zIndex: 1, opacity: 1.0, visible: false, type: 'base', url: '//maponline{s}.bdimg.com/starpic/?qt=satepc&u=x={x};y={y};z={z};v=009;type=sate&fm=46&app=webearth2&v=009&udt=20210803', },
              { name: '街景', zIndex: 2, opacity: 1.0, visible: false, type: 'base', url: '//online{s}.map.bdimg.com/onlinelabel/?qt=tile&x={x}&y={y}&z={z}&styles=ph&udt=20210803', },
              { name: '街②', zIndex: 3, opacity: 1.0, visible: false, type: 'base', url: '//online{s}.map.bdimg.com/onlinelabel/?qt=tile&x={x}&y={y}&z={z}&styles=pl&scaler=1&p=1', },
              { name: '默认', zIndex: 4, opacity: 1.0, visible: true, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=norma', },
              { name: '清新蓝', zIndex: 5, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=light', },
              { name: '黑夜', zIndex: 6, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=dark', },
              { name: '红色警戒', zIndex: 7, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=redalert', },
              { name: '精简', zIndex: 8, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=googlelite', },
              { name: '自然绿', zIndex: 9, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=grassgreen', },
              { name: '午夜蓝', zIndex: 10, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=midnight', },
              { name: '浪漫粉', zIndex: 11, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=pink', },
              { name: '青春绿', zIndex: 12, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=darkgreen', },
              { name: '清新蓝绿', zIndex: 13, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=bluish', },
              { name: '高端灰', zIndex: 14, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=grayscale', },
              { name: '强边界', zIndex: 15, opacity: 1.0, visible: false, type: 'base', url: '//api{s}.map.bdimg.com/customimage/tile?&x={x}&y={y}&z={z}&scale=1&styles=hardedge', },
              { name: '标签', zIndex: 16, opacity: 1.0, visible: false, type: 'overlay', url: '//online{s}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=sl&v=020', },
            ],
            layers: [
            ],
          },
